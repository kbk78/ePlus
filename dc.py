...
#for ea in files:
#    copyfile('C:\\EnergyPlusV8-4-0\\'+ea,ea)
#    idffile=os.getcwd()+'\\'+ea
#    for i in range(4,9):
#        subprocess.call(['C:\EnergyPlusV8-9-0\PreProcess\IDFVersionUpdater\Transition-V8-'+str(i)+'-0-to-V8-'+str(i+1)+'-0.exe',idffile],cwd='C:\EnergyPlusV8-9-0\PreProcess\IDFVersionUpdater')
